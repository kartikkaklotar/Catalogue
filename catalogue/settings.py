...
# Setup environ variable from .env file
env = environ.Env(
    DEBUG=(bool, False)
)
...
SECRET_KEY = env('SECRET_KEY')#'django-insecure-7sx744-(b83kzq6^shm^&ik+yghxk(n+23&+!gr+7b2a=t=vi7'
...
DATABASES = {
    'default': env.db_url('SQLITE_URL', default="sqlite:///{}".format(BASE_DIR / "db.sqlite3"))
}
